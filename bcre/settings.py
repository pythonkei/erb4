...
SECRET_KEY = 'django-insecure-*bsgv@ecvlu&hxra4oqic&1i6p$d-ab_&_2hb)my%a&klu3(#e'
...
# Following for Specific Static path for html call function, exiting used in base.html
STATIC_ROOT = os.path.join(BASE_DIR, 'static') 
# Project demo new added: Specific Static folder as BASE_DIR
STATIC_URL = 'static/'
STATICFILES_DIRS = [os.path.join(BASE_DIR, 'bcre/static')]
# Project demo new added: Specific static folder assets
# Then, terminal run command: python manage.py collectstatic
